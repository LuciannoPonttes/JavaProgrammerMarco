...
public class JogadorDao {
	...
	public boolean deletarJogadorPeloCpf(Jogador jogador) {
		...
		try {
			...
			declaracaoComando = (PreparedStatement) conexaoRecebida.prepareStatement(comandoSqlDeletar);// Preparação do
																										// comanda
			...
			logCrudJogador.escreverNoArquivoLogJogador(jogador, "Deletar");
		} catch (Exception mensagemErro) {
			System.out.println(mensagemErro);
	...
	public List<Jogador> buscarListaDeJogador() {
		...
		try {
			...
			declaracaoComando = (PreparedStatement) conexaoRecebida.prepareStatement(comandoSqlBuscar);// Preparação do
																										// comanda
																										// recebe o
																										// banco e o
																										// comando SQL
	...
	public boolean alterarJogador(Jogador jogador) {
		...
		String comandoSqlUpdate = "update  tabela_jogador set cpf = ?, nome = ?, email = ? where  cpf = ?";// Comando
																											// SQL
		...
		try {
			...
			declaracaoComando = (PreparedStatement) conexaoRecebida.prepareStatement(comandoSqlUpdate);// Preparação do
																										// comanda
																										// recebe o
																										// banco e o
																										// comando SQL
